...
import { addEnquiry, loadEnquiries } from "../Redux/Enquiries/EnquiryActions";

const SendEnquiry = ({ addEnquiry, loadEnquiries }) => {
...
export default connect(null, { addEnquiry, loadEnquiries })(SendEnquiry);
