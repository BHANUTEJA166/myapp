...
const ReviewsPage = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setData(res.data.Reviews); // 👈 extract Reviews only
      })
      .catch((err) => {
      ...
      <div className="container-fluid">
        ...
        <div className="text-center mb-5">
          ...
          <p className="lead text-muted mt-3">
            ...
            <br />
            Power, design, performance — rated by those who own it.
          </p>
        </div>
        ...
        <div className="text-center mt-5">
          ...
          <a href="#accessories" className="btn btn-dark btn-lg mt-3 me-3">
            Explore Accessories
          </a>
          <a href="#features" className="btn btn-outline-dark btn-lg mt-3">
            See Features
          </a>
        </div>
