...
const FeaturesPage = () => {
  ...
  useEffect(() => {
    axios
      ...
      .then((res) => {
        setData(res.data.Features); // 👈 extract ONLY Features
      })
      .catch((err) => {
    ...
    <section className="py-5 bg-light" id="features">
      <div className="container">
        ...
        <div className="text-center mt-5">
          <a href="#reviews" className="btn btn-dark btn-lg mt-3 me-3">
            Read Reviews
          </a>
          <a href="#accessories" className="btn btn-outline-dark btn-lg mt-3">
            Explore Accessories
          </a>
        </div>
      </div>
