...
const Viewfeatures = () => {
  ...
  // ✅ API change SAME STYLE AS REVIEWS
  useEffect(() => {
  ...
  const submitHandler = (e) => {
    ...
    setFeatures(updated);
    alert('Feature updated successfully! (demo only)');
  };
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              <form onSubmit={submitHandler}>
                <input type="text" name="category" value={category} onChange={changeData} className="form-control mb-2" placeholder="Category" />
                <input type="text" name="title" value={title} onChange={changeData} className="form-control mb-2" placeholder="Title" />
                <input type="text" name="description" value={description} onChange={changeData} className="form-control mb-2" placeholder="Description" />
                <input type="text" name="details" value={details} onChange={changeData} className="form-control mb-2" placeholder="Details" />
                <input type="text" name="specs" value={specs} onChange={changeData} className="form-control mb-2" placeholder="Specs" />
                <input type="text" name="benefit" value={benefit} onChange={changeData} className="form-control mb-2" placeholder="Benefit" />
